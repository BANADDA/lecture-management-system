            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.students.update', $student) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="current_year" id="current_year" class="form-control @error('current_year') is-invalid @enderror" value="{{ old('current_year', $student->current_year) }}" required min="1">
                        @error('current_year')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="current_semester" id="current_semester" class="form-select @error('current_semester') is-invalid @enderror" required>
                            ...
                            <option value="1" {{ old('current_semester', $student->current_semester) == 1 ? 'selected' : '' }}>1</option>
                            <option value="2" {{ old('current_semester', $student->current_semester) == 2 ? 'selected' : '' }}>2</option>
                        </select>
