...
<x-navigation>
    <div class="container-fluid py-4">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <h4 class="mb-3">Create New Lecturer</h4>
                ...
                <form action="{{ route('admin.lecturers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="office_location" id="office_location" class="form-control @error('office_location') is-invalid @enderror" value="{{ old('office_location') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="office_hours" id="office_hours" class="form-control @error('office_hours') is-invalid @enderror" value="{{ old('office_hours') }}" placeholder='e.g. {"Monday": "10-12", "Wednesday": "14-16"}'>
                        @error('office_hours')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
